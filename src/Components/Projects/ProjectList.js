export const projects = [
    {
      ...
      photos: [
        ...
        "/Images/ProjectPictures/Parkunity/Parkunity_3.png",
        "/Images/ProjectPictures/Parkunity/Parkunity_4.png",
        "/Images/ProjectPictures/Parkunity/Parkunity_5.png",
        "/Images/ProjectPictures/Parkunity/Parkunity_6.png",
        "/Images/ProjectPictures/Parkunity/Parkunity_7.png",
      ],
      description: "Parkunity is a hyperlocal event discovery platform centered around a live heatmap of parks and outdoor venues. Attendees can see a real-time green-to-red heatmap showing where events are clustering in their area, tap into individual events, RSVP, and earn ParkPoints loyalty rewards for actually showing up. Organizers can create events in minutes using a multi-step form that automatically generates professional event posters using Gemini's generative image model. Just describe the vibe, and the poster is ready. The event creation page also includes a speech-to-text button, making the platform more accessible and hands-free.",
      skills: [
        {
          title: "Next JS",
    ...
    },
    {
      ...
      photos: [
        ...
        "/Images/ProjectPictures/ProjectUCodeCourseLayout.png"
      ],
      description: "Project UCode is a non-profit organization established to encourage and foster the education of computer science, engineering, and specifically programming. This platform was designed as a place where students can learn online, sign up for live classes and make a local impact.",
      skills: [
        {
          title: "React JS",
          icon: "/Images/Icons/react-svgrepo-com.svg",
